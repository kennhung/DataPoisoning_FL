def generate_experiment_ids(start_idx, num_exp):
    ...
    for i in range(num_exp):
        ...
        log_files.append("out/" + idx + ".log")
        results_files.append("out/" + idx + "_results.csv")
        models_folders.append("out/" + idx + "_models")
        worker_selections_files.append("out/" + idx + "_workers_selected.csv")
